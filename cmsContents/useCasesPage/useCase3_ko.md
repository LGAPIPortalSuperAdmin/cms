...
contents: >-2
  ...
  \    <i className="usecase-cont__icon bell"></i>스마트 회의실의 공기 청정 자동화 시스템
  ...
  \    <i className="usecase-cont__icon thumb"></i>원활한 회의를 위한 지능형 디밍 알림
  ...
  \    <i className="usecase-cont__icon thumb"></i>조명 자동화로 최적의 시각 환경 제공
  ...
  \    <i className="usecase-cont__icon thumb"></i>인식 기반 자동 절전 시스템으로 에너지 절약 
