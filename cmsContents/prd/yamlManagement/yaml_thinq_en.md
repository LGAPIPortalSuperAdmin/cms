...
contents:
  ...
  code: >-
    ...
    tags:
      ...
      - name: Push Message
        description: |
          Push messages are generated by devices irregularly to notify the following four cases.
            1. Register Device
            2. Delete Device
            3. Edit Device Nickname
            4. Device Operation Completed (e.g., cycle completed) / Parts Replacement (e.g., filter replacement)
          ...
          ## Device Nickname Modification Message
          <SchemaDefinition
      ...
      - name: Event Message
        description: |
          Event messages are sent when the device's status is changed.
          ## Event message
          <SchemaDefinition
      ...
      schemas:
            ...
            event:
              ...
              properties:
                ...
                report:
                  type: object
                  description: |
                    It is sent only if the device status is changed. The schema for the status change is based on the device status response in Device Profile.
                pushType:
                  type: enum
                  description: DEVICE_STATUS
                userList:
                  type: array
                  description: List of users who registered device events
                  items:
                    type: string
        base-res:
          type: object
                ...
                response:
                  ...
                  properties:
                    apiServer:
                      ...
                      example: https://api-aic.lgthinq.com
                    mqttServer:
                      type: string
                      description: MQTT domain name
                      example: mqtts://a3phael99lf879-ats.iot.us-west-2.amazonaws.com:8883
                    webSocketServer:
                      type: string
                      description: WebSocket domain name
                      example: wss://a3phael99lf879-ats.iot.us-west-2.amazonaws.com:443/mqtt
        device-list-res:
        ...
        register_device:
          ...
          properties:
            push:
              type: object
              description: Callback Push Message
              properties:
                pushType:
                  type: enum
        ...
        delete_device:
          description: Device Deletion Message
          type: object
          properties:
            push:
              type: object
              ...
              properties:
                ...
                alias:
                  ...
                  description: Device Nickname
        change_nickname:
          description: Device Nickname Modification Message
          type: object
          properties:
            push:
              type: object
        ...
        complete_operation:
          ...
          properties:
            push:
              type: object
              description: An object containing information about push messages
              properties:
                pushType:
                  type: enum
                ...
                pushCode:
                  type: string
                  description: |
                    Device Operation Completed (e.g., cycle completed) / Parts Replacement (e.g., filter replacement)
                deviceType:
                  type: string
                  description: Device Type
                userList:
                  type: array
                  description: List of users who registered device push messages
                  items:
                    type: string
      examples:
        ...
        event_message_example:
          description: Air Conditioner - Operating Mode ON
          value:
