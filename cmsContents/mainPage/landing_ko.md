...
contents: >-
  ...
  \        <div className="main-visual type-white">
  ...
  \            <source src="/assets/videos/visual_movie_v2.mp4" type="video/mp4" />
  ...
  \              Smart Solution Connectingspace and people


  \              <small>공간과 사람을 연결하는 스마트 솔루션</small>
  ...
  \              Life's Good! Secure technology that automates your space and makes it more special.


  \              <br />


  \              Maximize user satisfaction, boost your future
  ...
  \              <CoButton className="btn-round-black btn-l" onClick={() => (window.location.href = '/pub/LG-P-MP-0201S')}>
